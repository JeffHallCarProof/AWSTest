        ...
        return (
          <View style={styles.container}>
            <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
              <Text style={{ paddingLeft: 50, paddingRight: 50, fontWeight: 'bold', fontSize: 20}}>Hot Dog!</Text>
            ...
            <Text>The hot dog or dog (also spelled hotdog) is a grilled or steamed link-sausage sandwich where the sausage is served in the slit of a special hot dog bun, 
              a partially sliced bun. It can also refer to just the sausage (the wurst or wörst) of its composition. 
              Typical sausages include wiener (Vienna sausage), frankfurter (or frank), or knackwurst. The names of these sausages also commonly refer to their assembled sandwiches 
            </Text>
